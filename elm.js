   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Player 1 Health")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-xs-8 col-offset-xs-2")]),
                      _U.list([A2($Html.button,
                              _U.list([$Html$Attributes.$class("btn btn-primary"),A2($Html$Events.onClick,address,Increment1)]),
                              _U.list([$Html.text("+")]))
                              ,A2($Html.div,_U.list([]),_U.list([$Html.text($Basics.toString(model.player1))]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("btn btn-primary"),A2($Html$Events.onClick,address,Decrement1)]),
                              _U.list([$Html.text("-")]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Player 1 Health")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-xs-10 col-offset-xs-1")]),
                      _U.list([A2($Html.button,
                              _U.list([$Html$Attributes.$class("btn btn-primary"),A2($Html$Events.onClick,address,Increment2)]),
                              _U.list([$Html.text("+")]))
                              ,A2($Html.div,_U.list([]),_U.list([$Html.text($Basics.toString(model.player2))]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("btn btn-primary"),A2($Html$Events.onClick,address,Decrement2)]),
                              _U.list([$Html.text("-")]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,
